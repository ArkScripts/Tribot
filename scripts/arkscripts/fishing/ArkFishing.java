...
@ScriptManifest(authors = {"Marcusihno"}, category = "Fishing", name = "ARKFisher", version = 1.00, description = "Fast, safe AIO Fishing trainer with dropping and banking. ABC2/10 compliant.", gameMode = 1)
...
public class ArkFishing extends Script implements Starting, Painting, MessageListening07, MousePainting {
	...
	public int reactionWaitMultiplier = 2;
